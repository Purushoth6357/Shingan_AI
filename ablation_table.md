...
| Model | Loss Configuration | Params | FLOPs | PSNR | SSIM | GMC | FPS | GPU Mem (MB) | Epoch Time (s) |
|-------|-------------------|--------|-------|------|------|-----|-----|--------------|----------------|
| **Exp 001** (Baseline CNN, 4 blocks) | Charbonnier | ~0.48 M | 7.90 G | 26.42 | 0.656 | - | 24 | - | - |
| **Exp 002** (Baseline CNN, 4 blocks) | Charbonnier + Sobel | ~0.48 M | 7.90 G | 28.50 | 0.787 | *TBD* | 24 | - | - |
| **Exp 003** (Baseline CNN, 4 blocks) | Charb + Sobel + FFL | ~0.48 M | 7.90 G | *TBD* | *TBD* | *TBD* | *TBD* | *TBD* | *TBD* |
| **Exp 003b** (Capacity CNN, 5 blocks)| Charb + Sobel + FFL | ~0.55 M | 9.11 G | *TBD* | *TBD* | *TBD* | *TBD* | *TBD* | *TBD* |
| **Exp 004** (Hybrid CNN+Transformer) | Charb + Sobel + FFL | ~0.52 M | 8.54 G | *TBD* | *TBD* | *TBD* | *TBD* | *TBD* | *TBD* |
